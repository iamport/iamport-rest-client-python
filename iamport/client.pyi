...
class Iamport(object):
    ...
    def _delete(self, url: str, payload: Optional[Dict[str, Any]] = ...) -> Dict: ...

    def find_by_status(self, status: str, **kwargs) -> Dict: ...
    ...
    def customer_delete(self, customer_uid: str, **kwargs) -> Dict: ...
